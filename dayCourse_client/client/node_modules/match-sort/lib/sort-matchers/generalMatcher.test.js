...
var generalMatcher_1 = require("./generalMatcher");
var countries_1 = require("../test-data/countries");
describe('generalMatcher', function () {
    it('Sorts strings as expected', function () {
        var result = generalMatcher_1.generalMatcher.sort('nor', countries_1.iso3166countries);
    ...
    it('Sorts acronyms as expected', function () {
        var result = generalMatcher_1.generalMatcher.sort('USA', countries_1.iso3166countries);
        var expectedResultStart = [
    ...
    it('Ignores accents and special symbols', function () {
        var result = generalMatcher_1.generalMatcher.sort('cote divoire', countries_1.iso3166countries);
        var expectedResultStart = ['Côte d\'Ivoire'];
        expect(result.slice(0, expectedResultStart.length)).toEqual(expectedResultStart);
    });
    it('Hits when characters are in the wrong order', function () {
        var result = generalMatcher_1.generalMatcher.sort('nowray', countries_1.iso3166countries);
        var expectedResultStart = ['Norway'];
        expect(result.slice(0, expectedResultStart.length)).toEqual(expectedResultStart);
    });
    it('Returns the array unchanged when no search is given', function () {
        var result = generalMatcher_1.generalMatcher.sort('', countries_1.iso3166countries);
